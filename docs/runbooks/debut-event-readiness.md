...
**Also fixed 2026-09-18, same deploy (`b3d9c366`, live 11:24, fra1 verified):** comment limit 1000 → 3000 — the admin could not answer the first real newcomer question (2 277 characters) and the UI only said „Validation failed". Verified on prod without a write: a 3001-character comment is refused with the new message. Open: counter + localized message on the comment boxes.
