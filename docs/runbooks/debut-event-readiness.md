...
- Phone chrome, in this order: execute the masthead hide-on-scroll plan on a branch + Vercel preview link for a real-phone pass. (A combined pin bar + „# Tags" chip was proposed here by the assistant; the user answered „ok, let us leave" on 09-18 — NOT approved, not planned.)
