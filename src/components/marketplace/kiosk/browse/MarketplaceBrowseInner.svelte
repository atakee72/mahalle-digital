...
<a
  ...
  class="fixed bottom-16 right-4 z-30 w-14 h-14 rounded-full bg-[#b97a1a] text-paper border-2 border-ink font-bricolage font-bold text-[28px] leading-none shadow-[3px_3px_0_var(--k-ink,#0e1033)] flex items-center justify-center lg:hidden"
