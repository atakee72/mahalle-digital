...
const de = {
  ...
  'nc.mention.post': '{actor} hat dich erwähnt: ‚{title}‘',
  'nc.mention.comment': '{actor} hat dich in einem Kommentar erwähnt: ‚{title}‘',
  'nc.adminHint.post': 'Admin-Hinweis in einem Beitrag',
  'nc.adminHint.comment': 'Admin-Hinweis in einem Kommentar',
  ...
  'compose.body.tip': 'tipp · @ und ein name erwähnt jemanden im kiez',
  ...
  'compose.error.titleShort': 'Titel zu kurz (mind. 5 Zeichen).',
  'compose.error.titleLong': 'Titel zu lang (max. 80 Zeichen).',
  'compose.error.bodyShort': 'Text zu kurz (mind. 10 Zeichen).',
  'compose.error.bodyLong': 'Text zu lang (max. 2000 Zeichen).',
  'compose.error.tags': 'Zu viele Tags (max. 3).',
  'compose.error.images': 'Zu viele Bilder (max. 5).',
  'compose.error.publish': 'Veröffentlichen fehlgeschlagen.',
  ...
  'auth.err.nameProtected': 'Dieser Name ist dem Mahalle-Team vorbehalten. Bitte wähl einen anderen.',
  'auth.err.handleInvalid': '3–20 Zeichen: a–z, 0–9 und _',
  'auth.err.handleReserved': 'Dieser @Name ist reserviert.',
  'auth.err.handleTaken': 'Dieser @Name ist schon vergeben.',
...
const en: Dict = {
  ...
  'nc.mention.post': '{actor} mentioned you in ‘{title}’',
  'nc.mention.comment': '{actor} mentioned you in a comment on ‘{title}’',
  'nc.adminHint.post': 'Admin note in a post',
  'nc.adminHint.comment': 'Admin note in a comment',
  ...
  'compose.body.tip': 'tip · @ and a name mentions someone in the kiez',
  ...
  'compose.error.titleShort': 'Title too short (at least 5 characters).',
  'compose.error.titleLong': 'Title too long (at most 80 characters).',
  'compose.error.bodyShort': 'Text too short (at least 10 characters).',
  'compose.error.bodyLong': 'Text too long (at most 2000 characters).',
  'compose.error.tags': 'Too many tags (at most 3).',
  'compose.error.images': 'Too many images (at most 5).',
  'compose.error.publish': 'Publishing failed.',
  ...
  'news.kiez.kicker': 'From the Kiez',
  ...
  'auth.err.nameProtected': 'That name is reserved for the Mahalle team. Please pick another.',
  'auth.err.handleInvalid': '3–20 characters: a–z, 0–9 and _',
  'auth.err.handleReserved': 'That @name is reserved.',
  'auth.err.handleTaken': 'That @name is already taken.',
